...
class AutoConstants:
    ...
    constraints = TrapezoidProfileRadians.Constraints(kMaxAngularSpeedRadiansPerSecond, kMaxAngularSpeedRadiansPerSecondSquared)

    kPXController = PIDController(1.0, 0.0, 0.0)
    kPYController = PIDController(1.0, 0.0, 0.0)
    kPThetaController = ProfiledPIDControllerRadians(1.0, 0.0, 0.0, constraints)

    pidConstants = HolonomicDriveController(kPXController, kPYController, kPThetaController)

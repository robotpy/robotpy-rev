...
set up, configure, and tune your REV hardware. For that kind of information,
refer to the `REVLib site <https://docs.revrobotics.com/docs/first-robotics-competition>`_.
